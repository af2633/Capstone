...
while True:
    ...
    #     update_people(person_id)
    # if user == '2':
    #     view_all_courses()

    # if user == '3':
    #     view_all_cohorts()
    #     cohort = input("Please enter a cohort id to view a cohort:\n")
    ...
    # if user == '7':
    #     search_person()
    #     person_id = input("Please enter an ID number to view all individuals info:\n")
    ...
    # if user == '12':
    #     remove_student_cohort()
        

    # if user == '13':
    #     student_complete_course()
